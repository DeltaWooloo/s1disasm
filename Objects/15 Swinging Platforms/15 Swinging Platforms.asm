...
; ===========================================================================
	...
	include "Objects/shared/sub MvSonicOnPtfm.asm"
...
Map_Swing_GHZ:	include	"Objects/15 Swinging Platforms/maps/Swinging Platforms (GHZ).asm"
Map_Swing_SLZ:	include	"Objects/15 Swinging Platforms/maps/Swinging Platforms (SLZ).asm"
