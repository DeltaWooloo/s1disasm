...
Map_SBall:	include	"Objects/57 SYZ, LZ Spiked Ball and Chain/maps/Spiked Ball and Chain (SYZ).asm"
Map_SBall2:	include	"Objects/57 SYZ, LZ Spiked Ball and Chain/maps/Spiked Ball and Chain (LZ).asm"
