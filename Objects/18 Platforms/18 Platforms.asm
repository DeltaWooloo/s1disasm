...
Map_Plat_Unused:include	"Objects/18 Platforms/maps/Platforms (unused).asm"
Map_Plat_GHZ:	include	"Objects/18 Platforms/maps/Platforms (GHZ).asm"
Map_Plat_SYZ:	include	"Objects/18 Platforms/maps/Platforms (SYZ).asm"
Map_Plat_SLZ:	include	"Objects/18 Platforms/maps/Platforms (SLZ).asm"
