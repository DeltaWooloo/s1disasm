...
; ===========================================================================
		...
		include	"Objects/shared/sub ResumeMusic.asm"

; ===========================================================================

		include	"Objects/0A LZ Drowning Countdown/anim/Drowning Countdown.asm"

	if FixBugs=0
Map_UnusedFace:	include	"Objects/0A LZ Drowning Countdown/maps/Unused Sonic Face.asm"
	endif