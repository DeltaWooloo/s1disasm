...
; ===========================================================================
		...
		include	"Objects/69 SBZ Spinning Platforms and Trapdoors/anim/SBZ Spinning Platforms.asm"
Map_Trap:	include	"Objects/69 SBZ Spinning Platforms and Trapdoors/maps/Trapdoor.asm"
Map_Spin:	include	"Objects/69 SBZ Spinning Platforms and Trapdoors/maps/SBZ Spinning Platforms.asm"
