; ===========================================================================
; ---------------------------------------------------------------------------
; Subroutine to check if the object has hit a wall to the left or right
; In the prototype, this routine was shared between Splats (Obj4F) and Yadrin,
; but since Splats was deleted, it is only used by Yadrins anymore. See here:
...
ChkHitLeftRightWall:
		...
		moveq	#0,d3					; clear d3
		move.b	obActWid(a0),d3				; load object width to d3 (input param for wall collision detection subroutines)
...
; ===========================================================================
		...
		include	"Objects/50 Badnik - Yadrin/anim/Yadrin.asm"
Map_Yad:	include	"Objects/50 Badnik - Yadrin/maps/Yadrin.asm"
