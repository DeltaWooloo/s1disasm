...
; ===========================================================================
		...
		include "Objects/8B, 8C Try Again, End Eggman, End Emeralds/anim/Try Again & End Eggman.asm"
...
Map_EEgg:	include	"Objects/8B, 8C Try Again, End Eggman, End Emeralds/maps/Try Again & End Eggman.asm"
