...
; ===========================================================================
		...
		include	"Objects/80, 81 Continue Screen Elements and Sonic/anim/Continue Screen Sonic.asm"
Map_ContScr:	include	"Objects/80, 81 Continue Screen Elements and Sonic/maps/Continue Screen.asm"
