...
.spawn:
		...
		; indexed at ObjPosLZPlatform_Index (see "Zones/Labyrinth Zone/objpos/platforms/" folder). The same format is also used
...
Map_LConv:	include	"Objects/63 LZ Conveyor/maps/LZ Conveyor.asm"
