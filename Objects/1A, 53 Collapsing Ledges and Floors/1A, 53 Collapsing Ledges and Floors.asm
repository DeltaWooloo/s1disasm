...
Map_Ledge:	include	"Objects/1A, 53 Collapsing Ledges and Floors/maps/Collapsing Ledge.asm"
Map_CFlo:	include	"Objects/1A, 53 Collapsing Ledges and Floors/maps/Collapsing Floors.asm"
