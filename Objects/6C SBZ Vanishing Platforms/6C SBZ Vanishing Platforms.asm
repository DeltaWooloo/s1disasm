...
; ===========================================================================
		...
		include	"Objects/6C SBZ Vanishing Platforms/anim/SBZ Vanishing Platforms.asm"
Map_VanP:	include	"Objects/6C SBZ Vanishing Platforms/maps/SBZ Vanishing Platforms.asm"
