...
; ===========================================================================
		...
		include	"Objects/0E, 0F Title Screen - Sonic, Press Start, TM/anim/Title Screen Sonic.asm"
		include	"Objects/0E, 0F Title Screen - Sonic, Press Start, TM/anim/Press Start and TM.asm"

		include	"Objects/shared/sub AnimateSprite.asm"	; mixed in here, this was probably the first use of it

Map_PSB:	include	"Objects/0E, 0F Title Screen - Sonic, Press Start, TM/maps/Press Start and TM.asm"
Map_TSon:	include	"Objects/0E, 0F Title Screen - Sonic, Press Start, TM/maps/Title Screen Sonic.asm"
