...
; ---------------------------------------------------------------------------
		...
		include	"Objects/shared/sub RememberState.asm"		; check if offscreen: display sprite if no, delete if yes
...
; ===========================================================================
		...
		include	"Objects/40 Badnik - Moto Bug/anim/Moto Bug.asm"
Map_Moto:	include	"Objects/40 Badnik - Moto Bug/maps/Moto Bug.asm"
