...
namespace S1ObjectDefinitions.SYZ
{
	class Block : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			img = ObjectHelper.MapASMToBmp(artfile, "../../Objects/56 SYZ, SLZ Floating Blocks and LZ Doors/maps/Floating Blocks and Doors.asm", 0, 2);
			for (int i = 0; i < 8; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(artfile, "../../Objects/56 SYZ, SLZ Floating Blocks and LZ Doors/maps/Floating Blocks and Doors.asm", i, 2));
		}
