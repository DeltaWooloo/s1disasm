	...
	class SwingingPlatform : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../Objects/15 Swinging Platforms/art/SLZ Swinging Platform.nem", CompressionType.Nemesis), "../../Objects/15 Swinging Platforms/maps/Swinging Platforms (SLZ).asm", labels[i], i == 1 ? 0 : 2));
		}
