	...
	class SwingingSpikeball : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../Objects/58 SYZ Big Spiked Ball/art/SYZ Large Spikeball.nem", CompressionType.Nemesis), "../../Objects/58 SYZ Big Spiked Ball/maps/Big Spiked Ball.asm", labels[i], i == 2 ? 2 : 0));
		}
