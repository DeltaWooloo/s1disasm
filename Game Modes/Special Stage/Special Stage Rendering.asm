...
; (Previously separated into "Libraries/Start Location Array - Special Stages.asm")
; ---------------------------------------------------------------------------

SS_StartLoc:
		binclude	"Game Modes/Special Stage/startpos/ss1.bin"
		binclude	"Game Modes/Special Stage/startpos/ss2.bin"
		binclude	"Game Modes/Special Stage/startpos/ss3.bin"
		binclude	"Game Modes/Special Stage/startpos/ss4.bin"
		binclude	"Game Modes/Special Stage/startpos/ss5.bin"
		binclude	"Game Modes/Special Stage/startpos/ss6.bin"
