; ===========================================================================
; ---------------------------------------------------------------------------
; Level order array (extracted from "Objects/3A Got Through Card/3A Got Through Card.asm").
...
; SBZ2 -> SBZ3: "Objects/01 Sonic/01 Sonic.asm" under "Boundary_Bottom"
; SBZ3 -> FZ:   "Libraries/DynamicLevelEvents.asm" under "DLE_SBZ3"
